          ...
          <table cellspacing="0" cellpadding="0" border="0" summary="">
            <tr align="center">
              <td valign="middle" style="width: 100%;">
                <a href="#">
                  <img style="width: 125px; cursor: pointer" src="https://media.discordapp.net/attachments/694174984746172496/702139729071571036/Screen_Shot_2020-04-21_at_14.35.01.png" alt="Questioner">
                </a>
              </td>
            </tr>
          </table>
            ...
            <tr align="center">
              <td style="width: 100%; ">
                <div style="background: #EFEEEE; padding: 20px 0px">
                  <p style="line-height: 20px; font-size: 0.75rem; color: black;">You’re getting this message because your iScholars account is connected to <a href="#">${email}</a><br />
                      <a href="#">unsubscribe</a> from similar emails from this iScholars group
                  </p>
                </div>
              </td>
            </tr>
