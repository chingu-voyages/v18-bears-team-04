      ...
      <AboutUsStyle bgImg={bgImg}>
         ...
         <div className="vision">
            <div className="wrap">
               <h3>Vision</h3>
               <p>
                  iScholars has been built to empower a worldwide community of teachers and students and improve their communication with more transparency.
               </p>
            </div>
         </div>
         <div className="team">
            <div className="wrap">
               <h3>Meet the Team</h3>
               <p className="desc">The team consists of members from various countries.</p>
